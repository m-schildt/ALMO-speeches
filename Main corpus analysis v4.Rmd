...
sample_df2 <- read.csv(file = 'Data/aggregated/speeches.csv', header = TRUE)
```

## Creating the main corpus and tokens

We use the package quanteda for the analysis of the speeches. Quanteda uses corpus to...
...
As we will be focusing on the subset of the speeches, specifically on those by the President during 2020 and 2021, we need subsets of the corpuses...
